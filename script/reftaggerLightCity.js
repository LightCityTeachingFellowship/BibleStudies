    ...
    async function ifForStrongsNumberORforCrossRef() {
        ...
        if (e.target.matches('.translated, .strnum')) {
            ...
            if (originalWord) {
                ...
                context_menu.innerHTML = `<div class="cmtitlebar">${menu_inner}<div class="cmenu_navnclose_btns"><button class="cmenu_tsk ${cmenu_tsk_display}" onclick="toggleCMenuTSK(this)">TSK</button><button class="prv" ${prv_indx} ${prv_title} onclick="cmenu_goBackFront(this)" ${dzabled}></button><button class="nxt" onclick="cmenu_goBackFront(this)" disabled></button><button class="fillscreen_btn" onclick="context_menu.classList.toggle('fillscreen')"></button><button class="closebtn cmenu_closebtn" onclick="hideRightClickContextMenu()" title="[Escape]"></button></div></div>${newStrongsDef}`;
                // console.log('01');
                ...
                context_menu.innerHTML = `<div class="cmtitlebar">${srchBtn}<div class="cmenu_navnclose_btns"><button class="cmenu_tsk ${cmenu_tsk_display}" onclick="toggleCMenuTSK(this)">TSK</button><button class="prv" ${prv_indx} ${prv_title} onclick="cmenu_goBackFront(this)" ${dzabled}></button><button class="nxt" onclick="cmenu_goBackFront(this)" disabled></button><button class="fillscreen_btn" onclick="context_menu.classList.toggle('fillscreen')"></button><button class="closebtn cmenu_closebtn" onclick="hideRightClickContextMenu()" title="[Escape]"></button></div></div>${newStrongsDef}</div>`;
            }
        ...
        /* ||||||||||||||||||||||||||||||||||||||||| */
            ...
            if (e.target.matches('.crossrefs>span, span[ref]')) {
                ...
                cmtitlebar.innerHTML = cmtitletext + `<div class="cmenu_navnclose_btns"><button class="prv_verse" onclick="cmenuprvNxtverse(event, 'prev')"></button><button class="nxt_verse" onclick="cmenuprvNxtverse(event, 'next')"></button><button class="cmenu_tsk ${cmenu_tsk_display}" onclick="toggleCMenuTSK(this)">TSK</button><button class="prv" ${prv_indx} ${prv_title} onclick="cmenu_goBackFront(this)" ${dzabled}></button><button class="nxt" onclick="cmenu_goBackFront(this)" disabled></button><button class="fillscreen_btn" onclick="context_menu.classList.toggle('fillscreen')"></button><button class="closebtn cmenu_closebtn" onclick="hideRightClickContextMenu()" title="[Escape]"></button></div></div>`;
...
// if (!document.location.toString().includes('BibleTimelines')) {
